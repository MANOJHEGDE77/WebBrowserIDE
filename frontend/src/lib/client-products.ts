...
export const STATIC_PRODUCTS: Product[] = [
  {
    ...
    description: 'Flagship Digicomp development board featuring dual-core Xtensa LX7 @ 240MHz, 8MB PSRAM, Wi-Fi 4, Bluetooth 5.0 LE, and dual USB-C.',
    price: 649,
    stock: 50,
    stock_quantity: 50,
    in_stock: true,
    image: '/images/digicomp/ESP32-S3-front.png',
    image_url: '/images/digicomp/ESP32-S3-front.png',
    productUrl: '/products/101',
    product_url: '/products/101',
    specifications: { MCU: 'Xtensa LX7 Dual-Core', Clock: '240 MHz', PSRAM: '8 MB', Flash: '16 MB', Wireless: 'Wi-Fi 4 + BLE 5.0', USB: 'Dual USB-C (OTG+UART)' },
    tags: ['esp32-s3', 'esp32', 'xtensa', 'wifi', 'bluetooth', 'iot', 'microcontroller', 'digicomp', 'official'],
    keywords: 'esp32-s3 esp32 s3 dev board wifi bluetooth xtensa digicomp',
  },
  {
    id: 102,
    sku: 'DC-RP2350-01',
    ...
    category: 'Microcontrollers',
    subcategory: 'Microcontrollers',
    description: 'Next-generation development board with Dual ARM Cortex-M33 and Dual Hazard3 RISC-V cores at 150MHz with 520KB SRAM and advanced PIO.',
    price: 799,
    stock: 35,
    stock_quantity: 35,
    in_stock: true,
    image: '/images/digicomp/RP2350-front.png',
    image_url: '/images/digicomp/RP2350-front.png',
    productUrl: '/products/102',
    product_url: '/products/102',
    specifications: { Arch: 'Dual Cortex-M33 + Dual RISC-V', Clock: '150 MHz', SRAM: '520 KB', Flash: '8 MB QSPI', PIO: '12 State Machines' },
    tags: ['rp2350', 'arm', 'cortex-m33', 'risc-v', 'raspberry', 'microcontroller', 'digicomp'],
    keywords: 'rp2350 arm cortex risc-v microcontroller digicomp',
  },
  {
    id: 103,
    sku: 'DC-CH32V-01',
    name: 'CH32V006 RISC-V Dev Board',
    slug: 'ch32v006',
    category: 'Microcontrollers',
    subcategory: 'Microcontrollers',
    description: 'Ultra-affordable 32-bit RISC-V development platform powered by WCH QingKe core with hardware debug and rich peripherals.',
    price: 299,
    stock: 60,
    stock_quantity: 60,
    in_stock: true,
    image: '/images/digicomp/CH32V006-front.png',
    image_url: '/images/digicomp/CH32V006-front.png',
    productUrl: '/products/103',
    product_url: '/products/103',
    specifications: { Core: 'QingKe 32-bit RISC-V', Clock: '48 MHz', Flash: '32 KB', SRAM: '6 KB', Voltage: '3.3V / 5V' },
    tags: ['ch32v006', 'risc-v', 'wch', 'microcontroller', 'low-power', 'digicomp'],
    keywords: 'ch32v006 ch32v risc-v microcontroller digicomp',
  },
  {
    id: 104,
    sku: 'DC-FPGA-01',
    ...
    category: 'Microcontrollers',
    subcategory: 'FPGA',
    description: 'Research-grade FPGA development board with Xilinx Artix-7 35T, 100MHz clock, dual PMOD headers, and high-speed digital signal processing capabilities.',
    price: 4899,
    stock: 12,
    stock_quantity: 12,
    in_stock: true,
    image: '/images/digicomp/FPGA-front.png',
    image_url: '/images/digicomp/FPGA-front.png',
    productUrl: '/products/104',
    product_url: '/products/104',
    specifications: { FPGA: 'Xilinx Artix-7 XC7A35T', 'Logic Cells': '33,280', DSP: '90 Slices', Clock: '100 MHz Low-Jitter', IO: 'Dual PMOD + 68 GPIO' },
    tags: ['fpga', 'artix-7', 'xilinx', 'digital-logic', 'dsp', 'digicomp'],
    keywords: 'fpga artix-7 xilinx logic dsp digicomp',
  },
  {
    id: 105,
    sku: 'DC-BMS16S-01',
    name: 'Digicomp 16S Smart BMS Module',
    slug: 'digicomp-bms16s',
    category: 'Power',
    subcategory: 'BMS',
    description: 'Industrial-grade Battery Management System scalable from 1S to 16S cells. Features active balancing, Bluetooth telemetry, OVP/UVP/OCP protection.',
    price: 2499,
    stock: 20,
    stock_quantity: 20,
    in_stock: true,
    ...
    specifications: { Scalability: '1S to 16S Li-Ion / LiFePO4', Balancing: 'Active Cell Balancing', Protection: 'OVP, UVP, OCP, OTP', Telemetry: 'Bluetooth BLE + CAN' },
    tags: ['bms', 'battery', 'power', '16s', 'balancing', 'industrial', 'digicomp'],
    keywords: 'bms 16s battery management system active balancing digicomp',
  },
  {
    id: 1,
    sku: 'DC-ESP32-01',
