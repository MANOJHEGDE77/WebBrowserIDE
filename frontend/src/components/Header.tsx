...
import { ShoppingCart, Search, Cpu, Sparkles, Menu, X, LogOut, User as UserIcon, Terminal } from 'lucide-react';
    ...
    <header ref={headerRef} className="sticky top-0 z-40 bg-white border-b border-slate-200 shadow-xs">
      ...
      <div className="container mx-auto px-4 py-3.5 max-w-7xl flex items-center justify-between gap-4">
        ...
        <nav className="hidden lg:flex items-center gap-6 text-sm font-medium text-slate-700">
          ...
          <Link href="/hardware-lab" className="hover:text-sky-600 transition-colors flex items-center gap-1.5 font-medium">
